    ...
    >
      ...
      <div className="relative z-10 px-4 sm:px-8 max-w-4xl mx-auto text-center">
        ...
        >
          <Link
            href="/chat"
            className="inline-flex items-center gap-2 rounded-xl bg-white text-[#070707] font-bold text-sm uppercase tracking-[0.14em] px-6 py-3 hover:bg-white/90 transition-all duration-200 shadow-lg"
          >
            Start Chatting
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-xl border border-white/20 text-white/80 font-bold text-sm uppercase tracking-[0.14em] px-6 py-3 hover:bg-white/5 hover:border-white/40 transition-all duration-200"
          >
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-2xl px-4 sm:px-8">
        ...
        <Link
          href="/chat"
          className="inline-flex items-center gap-2 rounded-xl bg-white text-[#070707] font-bold text-sm uppercase tracking-[0.14em] px-8 py-4 hover:bg-white/90 transition-all duration-200 shadow-lg text-base"
        >
          Start Chatting Now
