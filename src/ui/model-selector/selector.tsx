...
const ModelSelector = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        className={`flex items-center gap-2 bg-transparent hover:bg-surface-hover text-text-primary px-3 py-2 rounded-xl border border-transparent hover:border-border cursor-pointer transition-all ${
      ...
      {isOpen && (
        <div className="absolute bottom-full left-0 mb-2 w-64 bg-surface border border-border rounded-xl shadow-2xl overflow-hidden z-50 max-h-[300px] overflow-y-auto">
